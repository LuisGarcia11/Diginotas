<?php
$datos_data_info_factura = "SELECT * FROM tbl15_info_asignar_asignatura_a_grado WHERE (cod_info_asignar_asignatura_a_grado = '$cod_info_asignar_asignatura_a_grado')";
...
$(document).ready(function(){
    $("#cod_grado").on('change', function () {
            ...
            $.post("edit_guardar_info_factura_asignar_asignatura_a_grado_ajax.php", { valor:valor, campo:campo, tipo_ajax:tipo_ajax, id:<?php echo $cod_info_asignar_asignatura_a_grado; ?> }, function(data){
                $("#modelo").html(data);
        });
   });
});
...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
    <table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
      <tr>
        ...
        <th style="text-align:center;"><a href="../admin/lista_asignar_asignatura_a_grado.php"><img src="../imagenes/guardar.png" class="img-polaroid" alt=""></a></th>
