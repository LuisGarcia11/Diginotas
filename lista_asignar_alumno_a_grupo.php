...
<a class="btn btn-success" href="../admin/crear_asignar_alumno_a_grupo.php">Asignar Estudiantes a Grupos</a>
<!--
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            ...
            <input type="text" class="form-control" id="buscar" placeholder="Grupo" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span>
        </div>
...
<input type="hidden" class="form-control" id="pagina" value="<?php echo $pagina; ?>">
<!-- ***************************************************************************************************************************** -->
<!-- 1******************************************************* FIN MODULO PRINCIPAL *********************************************** -->
<!-- ***************************************************************************************************************************** -->
...
<script type="text/javascript" src="../admin/busqueda_paginacion_asignar_alumno_a_grupo_ajax.js"></script>
