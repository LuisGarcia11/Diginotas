...
$titulo_doc_pdf                    = 'PLANILLA_GRUPO'.'_'.$nombre_grupo.'_'.$anyo;
$autor_doc_pdf                     = 'PLANILLA_GRUPO'.str_pad($cod_info_grupo_alumno, 4, "0", STR_PAD_LEFT).'_'.$nombre_grupo.'_'.$anyo;
$creador_doc_pdf                   = 'PLANILLA_GRUPO'.str_pad($cod_info_grupo_alumno, 4, "0", STR_PAD_LEFT).'_'.$nombre_grupo.'_'.$anyo;
$tema_doc_pdf                      = 'PLANILLA_GRUPO'.str_pad($cod_info_grupo_alumno, 4, "0", STR_PAD_LEFT).'_'.$nombre_grupo.'_'.$anyo;
$palabras_claves_doc_pdf           = 'PLANILLA_GRUPO'.str_pad($cod_info_grupo_alumno, 4, "0", STR_PAD_LEFT).'_'.$nombre_grupo.'_'.$anyo;
...
$nombres_completos                 = "PLANILLA_GRUPO";
...
$codigoHTML.='
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:15pt; width:100%">
          <tr>
            <td style="text-align:center" width="125" valign="top"><strong>Planilla De Estudiantes</strong></td>
           </tr>
        </table>
        ';
...
$codigoHTML.='
          <tr>
            ...
            <td style="text-align:left">'.$identificacion_alumno.'</td>
            <td style="text-align:left">'.$nombres_apellidos_alumno.'</td>
          </tr>';
}
$codigoHTML.='
</table>';
...
$ruta = '../pdfs/';
$nombre_archivo = 'PLANILLA_GRUPO'.'_'.$nombre_grupo.'_'.$anyo.'.pdf';
