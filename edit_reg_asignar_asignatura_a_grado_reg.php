...
$pagina = addslashes($_GET['pagina'])."?&foco=".$foco."&cod_info_asignar_asignatura_a_grado=".$cod_info_asignar_asignatura_a_grado."&buscar_por=".$buscar_por."&cuenta=".$cuenta."&cod_caja_virtual=".$cod_caja_virtual.$condicional_url_categoria."&pagina=facturacion_grupo_temporal.php";

$sql_info = "SELECT * FROM tbl15_info_asignar_asignatura_a_grado WHERE (cod_info_asignar_asignatura_a_grado = '$cod_info_asignar_asignatura_a_grado')";
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_asignar_asignatura_a_grado cod_info_asignar_asignatura_a_grado, cod_asignatura, nombre_asignatura, cuenta, cod_administrador, cod_caja_virtual) 
