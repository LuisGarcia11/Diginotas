...
<!-- //////////////////////////////////////////////////////////////////////////////////////////////////////////// -->
    <table class="table table-striped" border="1" cellspacing="0" cellpadding="20">
      ...
      <tr>
        ...
        <th style="text-align:center;"><?php echo $nombre_asignatura ?></th>
        ...
        <th style="text-align:center;"><a href="../admin/ver_planilla_alumno_grupo_pdf.php?cod_info_asignar_alumno_a_grupo=<?php echo $cod_info_asignar_alumno_a_grupo?>&cod_asignatura=<?php echo $cod_asignatura ?>&pagina=<?php echo $pagina ?>" target="_blank"><img src="../imagenes/planilla_pdf.png" class="img-polaroid" title="Imprimir Planilla Estudiantes" alt=""></a></td>
        ...
        <th style="text-align:center;">Periodo:
            ...
            <a id="url_modif" target="_blank"><img src="../imagenes/planilla_pdf.png" title="Imprimir Notas"></a>
        </th>
      </tr>
