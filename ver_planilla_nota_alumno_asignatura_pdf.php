...
$sql_total_reg_alumno_a_grupo = "SELECT * FROM tbl15_asignar_alumno_a_grupo WHERE (cod_info_asignar_alumno_a_grupo = '$cod_info_asignar_alumno_a_grupo') AND (cod_alumno = '$cod_alumno') GROUP BY cod_alumno";
...
$sql_alumno_a_grupo = "SELECT * FROM tbl15_asignar_alumno_a_grupo WHERE (cod_info_asignar_alumno_a_grupo = '$cod_info_asignar_alumno_a_grupo') AND (cod_alumno = '$cod_alumno') GROUP BY cod_alumno";
...
$sql_alumno = "SELECT * FROM tbl15_alumno WHERE (cod_alumno = '$cod_alumno')";
$consulta_alumno = mysqli_query($conectar, $sql_alumno);
$matriz_alumno = mysqli_fetch_assoc($consulta_alumno);

$nombres_apellidos_alumno                     = $matriz_alumno['nombre1_alumno'].' '.$matriz_alumno['nombre2_alumno'].' '.$matriz_alumno['apellido1_alumno'].' '.$matriz_alumno['apellido2_alumno'];
...
$codigoHTML.='
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:15pt; width:100%">
          <tr>
            <td style="text-align:center" width="125" valign="top"><strong>Reporte de Calificaciones Por Estudiante</strong></td>
           </tr>
        </table>
        ';
...
$codigoHTML.='
        <table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
          <tr>
            ...
            <td style="text-align:center" width="125" valign="top"><strong>Nombre Estudiante</strong></td>
          ...
          <tr>
            ...
            <td style="text-align:center" width="125" valign="top">'.$nombres_apellidos_alumno.'</td>
...
$codigoHTML.='
        <table align="center" border="1" cellpadding="0" cellspacing="0" style="font-family:mono; font-size:'.$tamano_font_factura_emp.'pt; width:100%">
          <tr>
            <td style="text-align:center" width="350" valign="top"><strong>Asignatura</strong></td>
           ';
...
$sql_asignar_alumno_a_grupo = "SELECT * FROM tbl15_asignar_alumno_a_grupo WHERE (cod_info_asignar_alumno_a_grupo = '$cod_info_asignar_alumno_a_grupo') AND (cod_alumno = '$cod_alumno')
...
$codigoHTML.='
          <tr>
            <td style="text-align:left" width="100" valign="top">'.$nombre_asignatura.'</td>
           ';
