...
$sql_info = "SELECT * FROM tbl15_info_asignar_asignatura_a_grado WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$sql_autoincremento_info_factura = "SELECT AUTO_INCREMENT FROM INFORMATION_SCHEMA.TABLES WHERE TABLE_SCHEMA = '$base_datos' AND TABLE_NAME = 'tbl15_info_asignar_asignatura_a_grado'";
...
$cod_info_asignar_asignatura_a_grado             = $datos_autoincremento_info_factura['AUTO_INCREMENT'];
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_info_asignar_asignatura_a_grado (cod_info_asignar_asignatura_a_grado, cuenta cod_administrador, cod_caja_virtual, nombre_estado_factura) 
VALUES ('$cod_info_asignar_asignatura_a_grado', '$cuenta', '$cod_administrador', '$cod_caja_virtual', '$nombre_estado_factura')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$sql_data = "INSERT INTO tbl15_asignar_asignatura_a_grado_temporal cod_info_asignar_asignatura_a_grado, cod_asignatura, nombre_asignatura, cuenta, cod_administrador, cod_caja_virtual) 
VALUES ('$cod_info_asignar_asignatura_a_grado', '$cod_asignatura', '$nombre_asignatura', '$cuenta', '$cod_administrador', '$cod_caja_virtual')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
//---------------------------------------------------------------------FACTURA NUEVA FIN----------------------------------------------------------------//
//---------------------------------------------------------------------FACTURA NUEVA FIN----------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------------------//
...
$sql_info_factura = "SELECT cod_info_asignar_asignatura_a_grado FROM tbl15_info_asignar_asignatura_a_grado WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_asignar_asignatura_a_grado             = $datos_info_factura['cod_info_asignar_asignatura_a_grado'];
$fecha_ymdhis                                   = date("Y-m-d H:is");
