...
$sql_info = "SELECT * FROM tbl15_info_grupo_alumno WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_info_grupo_alumno (cod_info_grupo_alumno, cuenta cod_administrador, cod_caja_virtual, nombre_estado_factura) 
VALUES ('$cod_info_grupo_alumno', '$cuenta', '$cod_administrador', '$cod_caja_virtual', '$nombre_estado_factura')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));

$sql_data = "INSERT INTO tbl15_grupo_alumno_temporal cod_info_grupo_alumno, cod_alumno, cuenta, cod_administrador, cod_caja_virtual) 
VALUES ('$cod_info_grupo_alumno', '$cod_alumno', '$cuenta', '$cod_administrador', '$cod_caja_virtual')";
$exec_data = mysqli_query($conectar, $sql_data) or die(mysqli_error($conectar));
//---------------------------------------------------------------------FACTURA NUEVA FIN----------------------------------------------------------------//
//---------------------------------------------------------------------FACTURA NUEVA FIN----------------------------------------------------------------//
//---------------------------------------------------------------------------------------------------------------------------------------------//
...
$sql_info_factura = "SELECT cod_info_grupo_alumno FROM tbl15_info_grupo_alumno WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
$cod_info_grupo_alumno             = $datos_info_factura['cod_info_grupo_alumno'];
$fecha_ymdhis                       = date("Y-m-d H:is");
