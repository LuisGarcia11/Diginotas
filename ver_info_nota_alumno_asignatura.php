...
$nombre_alumno                            = $matriz_alumno['nombre1_alumno'].' '.$matriz_alumno['nombre2_alumno'].' '.$matriz_alumno['apellido1_alumno'].' '.$matriz_alumno['apellido2_alumno'];
?>
...
var url_parameter = "../admin/ver_planilla_nota_alumno_asignatura_pdf.php";
...
reem_nombre_periodo = url_parameter+'?cod_info_asignar_alumno_a_grupo='+cod_info_asignar_alumno_a_grupo+'&cod_alumno='+cod_alumno+'&nombre_periodo='+nombre_periodo;
