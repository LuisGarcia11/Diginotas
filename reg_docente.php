...
<?php $nombre_pagina = "Registrar Docentes"; ?>
<!-- 1******************************************************* MODULO SUPERIOR *********************************************** -->
...
<a class="btn btn-success" href="#">Registrar Datos del Docente</a>
</div>
...
<form name="formulario_insersion" method="post" enctype="multipart/form-data" action="../admin/reg_docente_reg.php">
<fieldset>
...
<table border="1" class="table table-responsive">
	<thead>
		<tr>
			...
			<td style="text-align:left"><input class="input-block-level" name="identificacion_docente" id="identificacion_docente" type="number" value="" size="30" onkeypress="return event.charCode >= 48 && event.charCode <= 57" required /></td>
		</tr>
    	<tr>
    	...
    	<tr>
			...
			<td style="text-align:left"><input class="input-block-level" name="nombre1_docente" id="nombre1_docente" type="text" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Nombre 2:</th>
			<td style="text-align:left"><input class="input-block-level" name="nombre2_docente" id="nombre2_docente" type="text" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Apellido 1:</th>
			<td style="text-align:left"><input class="input-block-level" name="apellido1_docente" id="apellido1_docente" type="text" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Apellido 2:</th>
			<td style="text-align:left"><input class="input-block-level" name="apellido2_docente" id="apellido2_docente" type="text" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Fecha Nac:</th>
			<td style="text-align:left"><input class="input-block-level" name="fecha_nac_docente" id="fecha_nac_docente" type="date" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Direccion:</th>
			<td style="text-align:left"><input class="input-block-level" name="direccion_docente" id="direccion_docente" type="text" value="" size="30" required /></td>
		</tr>
    	<tr>
			<th style="text-align:right">Telefono:</th>
			<td style="text-align:left"><input class="input-block-level" name="telefono1_docente" id="telefono1_docente" type="number" value="" size="30" required /></td>
		</tr>
    	<tr>
    	...
    	<tr>
			...
			<td style="text-align:left"><input class="input-block-level" name="correo_docente" id="correo_docente" type="text" value="" size="30" /></td>
		</tr>
    	<tr>
...
$(document).ready(function(){
    $("#identificacion_docente").on('change', function () {
            var identificacion_docente = $(this).val();
            var campo = "identificacion_docente";
            var tipo_ajax = "tbl15_producto";
            $.post("verificar_existencia_docente_ajax.php", { identificacion_docente:identificacion_docente, campo:campo, tipo_ajax:tipo_ajax }, function(data){
