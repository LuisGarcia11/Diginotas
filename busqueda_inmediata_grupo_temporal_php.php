...
?>
<td style="text-align:center;"><a href="../admin/reg_grupo_temporal_reg.php?identificacion_alumno=<?php echo $identificacion_alumno?>&buscar_por=<?php echo $buscar_por?>&nombre_tipo_moneda=<?php echo $nombre_tipo_moneda?>&nombre_tipo_factura=<?php echo $nombre_tipo_factura?>&foco=<?php echo $foco?>&cod_estado_vacuna=<?php echo $cod_estado_vacuna?>&cuenta=<?php echo $cuenta?>&cod_caja_virtual=<?php echo $cod_caja_virtual?>&pagina=<?php echo $pagina?>"><img src="../imagenes/btn_anexar.png" class="img-polaroid" alt=""></a></td>
