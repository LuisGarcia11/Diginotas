...
$datos_factura = "SELECT cod_grupo_alumno_temporal FROM tbl15_grupo_alumno_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
xmlhttp.open("POST","../admin/busqueda_inmediata_grupo_temporal_php.php",true);
...
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/info_notas_temporal.php'); ?>
<!-- ***************************************************************************************************************************** -->
<!-- ***************************************************************************************************************************** -->
...
<tbody>
<?php
$sql_grupo_alumno_temporal = "SELECT * FROM tbl15_grupo_alumno_temporal WHERE (cuenta = '$cuenta_actual') AND (cod_caja_virtual = '$cod_caja_virtual') 
ORDER BY cod_grupo_alumno_temporal DESC";
...
$cod_grupo_alumno_temporal              = $datos_grupo_alumno_temporal['cod_grupo_alumno_temporal'];
...
$incre++;
?>
	<tr id="tr<?php echo $cod_grupo_alumno_temporal;?>">
        <td style="text-align:center;" id="nombre_producto_<?php echo $incre;?>"><?php echo $incre ?></td>
        <td style="text-align:center;" id="nombre_producto_<?php echo $incre;?>"><?php echo $nombres_alumno ?></td>
        <td style="text-align:center;" id="und_venta_<?php echo $incre;?>"><input name="nota1_alumno" type="number" id="nota1_alumno<?php echo $incre;?>" class="<?php echo $cod_venta_producto_temporal;?>" onChange="calc_total_venta();" value="<?php echo $nota1_alumno;?>" step="any" min=0 style="width: 70px;" /></td>
        <td style="text-align:center;" id="und_venta_<?php echo $incre;?>"><input name="falla_alumno" type="number" id="falla_alumno<?php echo $incre;?>" class="<?php echo $cod_venta_producto_temporal;?>" onChange="calc_total_venta();" value="<?php echo $falla_alumno;?>" step="any" min=0 style="width: 70px;" /></td>
        <td style="text-align:center;" id="und_venta_<?php echo $incre;?>"><input name="observacion" type="text" id="observacion<?php echo $incre;?>" class="<?php echo $cod_venta_producto_temporal;?>" onChange="calc_total_venta();" value="<?php echo $observacion;?>" style="width: 300px;" /></td>
	</tr id="tr<?php echo $cod_grupo_alumno_temporal;?>">
<?php } ?>
</tbody>
</table>
