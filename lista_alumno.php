...
<?php $nombre_pagina = "Lista Alumnos"; ?>
<!-- 1******************************************************* MODULO SUPERIOR *********************************************** -->
...
<a class="btn btn-success" href="../admin/reg_alumno.php">Registro de estudiantes</a>
<!--
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4"><input type="text" class="form-control" id="busqueda_ajax" placeholder="Nombre o Codigo del Estudiante" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span></div>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_alumno_ajax.js"></script>
