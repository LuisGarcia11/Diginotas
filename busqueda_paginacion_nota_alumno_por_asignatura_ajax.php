...
<tr>
    <th style="text-align:center" class="column-title">Ver Estudiante</th>
...
<tr class="even pointer">
    <td style="text-align:center;"><a href="../admin/ver_facturacion_grupo_asignatura.php?cod_info_asignar_alumno_a_grupo=<?php echo $cod_info_asignar_alumno_a_grupo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/ver.png" class="img-polaroid" title="Ver Estudiante" alt=""></a></td>
