...
$datos_info = "SELECT * FROM tbl15_info_asignar_asignatura_a_grado WHERE (cuenta = '$cuenta') AND (cod_caja_virtual = '$cod_caja_virtual')";
...
//---------------------------------------------------------------------------------------------------------------------------------------------//
$sql_data = "INSERT INTO tbl15_info_asignar_asignatura_a_grado (cod_info_asignar_asignatura_a_grado, cod_grado, nombre_grado, nombre_grado_letra, cuenta, cod_administrador, cod_caja_virtual, nombre_estado_factura) 
VALUES ('$cod_info_asignar_asignatura_a_grado', '$cod_grado', '$nombre_grado', '$nombre_grado_letra', '$cuenta', '$cod_administrador', '$cod_caja_virtual', '$nombre_estado_factura')";
