...
<?php $nombre_pagina = "Lista Docentes"; ?>
<!-- 1******************************************************* MODULO SUPERIOR *********************************************** -->
...
<a class="btn btn-success" href="../admin/reg_docente.php">Registro de Docente</a>
<!--
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4"><input type="text" class="form-control" id="busqueda_ajax" placeholder="Nombre o Codigo del Docente" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span></div>
...
<script type="text/javascript" src="../admin/busqueda_paginacion_docente_ajax.js"></script>
