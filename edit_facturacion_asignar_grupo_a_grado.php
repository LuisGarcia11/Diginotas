...
$cod_info_asignar_grupo_a_grado = addslashes($_GET['cod_info_asignar_grupo_a_grado']);

$pagina                            = $_SERVER['PHP_SELF'];
$pagina_local                      = $_SERVER['PHP_SELF'];
$incre                             = 0;
$tab                               = 'tbl15_asignar_grupo_a_grado';
$time_seg                          = time();
$fecha                             = date("Ymd");
$hora                              = date("His");
...
$datos_factura = "SELECT cod_asignar_grupo_a_grado FROM tbl15_asignar_grupo_a_grado WHERE (cod_info_asignar_grupo_a_grado = '$cod_info_asignar_grupo_a_grado')";
...
var cod_info_asignar_grupo_a_grado = "<?php echo $cod_info_asignar_grupo_a_grado ?>";
...
<table align="center" border="0" cellpadding="0" cellspacing="0" style="font-family:mono; width:100%">
    <tbody><tr>
        <td bgcolor="#fff" align="center"><strong><a href="../admin/lista_asignar_grupo_a_grado.php?pagina=<?php echo $pagina ?>">Editar Asignaturas a Grados</a></strong></td>
    </tr></tbody>
</table>
<br>
$
...
<!-- ***************************************************************************************************************************** -->
<?php include_once('../admin/edit_info_asignar_grupo_a_grado.php'); ?>
<!-- ***************************************************************************************************************************** -->
<!-- ***************************************************************************************************************************** -->
...
<tbody>
<?php
$campo                             = 'cod_asignar_grupo_a_grado';
$tipo                              = 'eliminar';
$nombre_tipo_moneda                = "COP";
$nombre_tipo_factura               = "POS";
$cod_estado_vacuna                 = "0";

$sql_asignar_grupo_a_grado = "SELECT * FROM tbl15_asignar_grupo_a_grado WHERE (cod_info_asignar_grupo_a_grado = '$cod_info_asignar_grupo_a_grado') 
ORDER BY cod_asignar_grupo_a_grado DESC";
$consulta_asignar_grupo_a_grado = mysqli_query($conectar, $sql_asignar_grupo_a_grado);
while ($datos_asignar_grupo_a_grado = mysqli_fetch_assoc($consulta_asignar_grupo_a_grado)) {

$cod_asignar_grupo_a_grado             = $datos_asignar_grupo_a_grado['cod_asignar_grupo_a_grado'];
$cod_info_asignar_grupo_a_grado                 = $datos_asignar_grupo_a_grado['cod_info_asignar_grupo_a_grado'];
$cod_asignatura                                      = $datos_asignar_grupo_a_grado['cod_asignatura'];
$nombre_asignatura                                   = $datos_asignar_grupo_a_grado['nombre_asignatura'];

$incre++;
?>
	<tr id="tr<?php echo $cod_asignar_grupo_a_grado;?>">
		<?php if ($cod_estado_eliminar_caja_mesa_virtual == '1') { ?><td  style="text-align:center;"><a href="../admin/eliminar.php?llave=<?php echo $cod_asignar_grupo_a_grado?>&cod_info_asignar_grupo_a_grado=<?php echo $cod_info_asignar_grupo_a_grado ?>&tab=<?php echo $tab ?>&tipo=<?php echo $tipo ?>&campo=<?php echo $campo ?>&cuenta=<?php echo $cuenta ?>&cod_caja_virtual=<?php echo $cod_caja_virtual ?>&pagina=<?php echo $pagina_local ?>"><img src="../imagenes/btn_excluir.png" class="img-polaroid" alt=""></a></td><?php } ?>
