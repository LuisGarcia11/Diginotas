...
$pagina_redirect                 = $pagina.'?cod_docente='.$cod_docente.'&pagina='.$pagina;
/* ----------------------------------------------------------------------------------------------------------/ */
$time                            = time();
...
$url_img_docente_orig_db          = $matriz_consulta['url_img_docente_orig'];
$url_img_docente_min_db           = $matriz_consulta['url_img_docente_min'];
/* ----------------------------------------------------------------------------------------------------------/ */
if ($url_img1 <> '') { 
...
$actualiza_docente = sprintf("UPDATE tbl15_docente SET url_img_docente_orig = '$url_img_docente_orig', url_img_docente_min = '$url_img_docente_min' WHERE cod_docente = '$cod_docente'");
$resultado_actualiza_docente = mysqli_query($conectar, $actualiza_docente) or die(mysqli_error($conectar));
