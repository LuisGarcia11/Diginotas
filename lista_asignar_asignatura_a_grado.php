...
<a class="btn btn-success" href="../admin/crear_asignar_asignatura_a_grado.php">Asignar Asignaturas a Grados</a>
<!--
...
<form class="form-horizontal" role="form" id="ingresos">
        ...
        <div class="col-md-4">
            <select class="form-control" name="anyo" id="anyo" onchange="load(1);" style="width: 60px;">
            <?php if (isset($anyo)) { echo ""; } else { echo  "<option value='' selected >Selecione</option>"; }
            $consulta2_sql = ("SELECT nombre_tabla_anyo FROM tbl15_tabla_anyo ORDER BY nombre_tabla_anyo ASC");
            ...
            <input type="text" class="form-control" id="buscar" placeholder="Grado" onkeyup='load(1);'><button type="button" class="btn btn-default" onclick='load(1);'><span class="glyphicon glyphicon-search" ></span> Buscar</button><span id="loader"></span>
        </div>
...
<input type="text" class="form-control" id="pagina" value="<?php echo $pagina; ?>">
<!-- ***************************************************************************************************************************** -->
<!-- 1******************************************************* FIN MODULO PRINCIPAL *********************************************** -->
<!-- ***************************************************************************************************************************** -->
...
<script type="text/javascript" src="../admin/busqueda_paginacion_asignar_asignatura_a_grado_ajax.js"></script>
