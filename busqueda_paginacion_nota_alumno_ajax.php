...
<tr>
    <th style="text-align:center" class="column-title">Ver Estudiantes</th>
...
<tr class="even pointer">
    <td style="text-align:center;"><a href="../admin/ver_alumno_por_grupo_nota.php?cod_info_asignar_alumno_a_grupo=<?php echo $cod_info_asignar_alumno_a_grupo?>&pagina=<?php echo $pagina?>"><img src="../imagenes/ver.png" class="img-polaroid" title="Ver Estudiantes" alt=""></a></td>
