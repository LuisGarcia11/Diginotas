...
$cod_info_asignar_grupo_a_grado                   = addslashes($_POST['cod_info_asignar_grupo_a_grado']);
...
?>
<td style="text-align:center;"><a href="../admin/edit_reg_asignar_grupo_a_grado_reg.php?cod_asignatura=<?php echo $cod_asignatura?>&cod_info_asignar_grupo_a_grado=<?php echo $cod_info_asignar_grupo_a_grado?>&buscar_por=<?php echo $buscar_por?>&nombre_tipo_moneda=<?php echo $nombre_tipo_moneda?>&nombre_tipo_factura=<?php echo $nombre_tipo_factura?>&foco=<?php echo $foco?>&cod_estado_vacuna=<?php echo $cod_estado_vacuna?>&cuenta=<?php echo $cuenta?>&cod_caja_virtual=<?php echo $cod_caja_virtual?>&pagina=<?php echo $pagina?>"><img src="../imagenes/btn_anexar.png" class="img-polaroid" alt=""></a></td>
